...
- habitat_palette, exposure_palette:
  ...
  `"habitat"` and `"exposure"` palettes. The exposure palette covers
  every level of the vocabulary; the habitat palette names the five
  zones sampled on most trips, so pass
